	...
	theme: {
		...
		extend: {
			...
			keyframes: {
				...
				cinematic: {
					'0%': { transform: 'scale(1.05)', filter: 'brightness(0.8)' },
			...
			animation: {
				...
				'parallax-bg': 'parallaxBg 1s ease-out forwards',
			...
			backgroundImage: {
				...
				'blue-gradient': 'linear-gradient(90deg, #0066CC 0%, #33C3F0 100%)',
				'blue-dark-gradient': 'linear-gradient(90deg, #003366 0%, #1EAEDB 100%)',
				'hero-gradient': 'linear-gradient(to bottom, rgba(0,0,0,0.2) 0%, rgba(0,0,0,0.6) 100%)',
			},
			transitionProperty: {
				'height': 'height',
